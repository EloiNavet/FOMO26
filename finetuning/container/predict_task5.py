"""FOMO26 Task 5 (polymicrogyria) container entrypoint. Official I/O: --t1 --output (.txt probability)."""
...
def main():
    ap = argparse.ArgumentParser(description="FOMO26 Task 5: Polymicrogyria Classification")
