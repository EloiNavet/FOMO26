...
def main(cfg: DictConfig) -> None:
    ...
    # SSL encoder transfer (encoder_only -> the regression head stays randomly initialised).
    weights, _ = resolve_pretrained_weights(cfg, model, weights)
    ...
    model_module = fast_instantiate(
        ...
        weight_decay=cfg.training.get("weight_decay", cfg.model.weight_decay),
